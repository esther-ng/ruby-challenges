...
#why is it defined this way? this defines local/instance variables so they may be used outside...? Or it's defining a method so that if post is the name of the object, post.method will call up the content? 
    def title
        @title
    end
